...
namespace WindowsFormsApplication1
{
    class MouseHook
    {
        public static event EventHandler MouseUp = delegate { };
        public static event EventHandler MouseDown = delegate { };
        public static event EventHandler MouseMove = delegate { };
        //public static event EventHandler MouseHover = delegate { };
